...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb justify-content-end">
		...
		<li class="breadcrumb-item active" aria-current="page">FileUpload</li>
	</ol>
</nav>
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="card">
				<div class="card-body">
					...
					<!-- 파일 업로드할때는 form 엘리먼트에 encType속성을 반드시 추가해야한다. -->
					...
					<script>
						$(function(){
							$("#saveMember1").click(function(event){
								event.preventDefault();
								
								f.submit();
							});
							$("#saveMember2").click(function(event){
								event.preventDefault();
