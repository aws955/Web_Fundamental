				...
				<div class="card-body">
					...
					<div class="table-responsive-md">
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="view.jsp?seq=<%=gtsmdto.getSeq()%>&page=<%=cPage%>"><%=gtsmdto.getName() %></a></td>
						...
						<div class="text-right">
							<a href="register.jsp?page=<%=cPage %>" class="btn btn-outline-primary">가입</a>
							<a href="login.jsp?page=<%=cPage %>" class="btn btn-outline-primary">로그인</a>
						</div>
					</div>
				</div>
			</div>
